...
<br/>
<a href="admin-employer-list.php">&lt;&lt; Back</a><br/><br/>
<?php
    if (isset($GLOBALS['err_info']) && $GLOBALS['err_info'] != '') {
        echo "<span class='wrong'>".$err_info."</span><br/>";
    }
?>
<form action="admin-employer-create-done.php" method="post">
    <br/>
    <span>Login Name: </span>admin<br/>
    <input class="wp90" type=hidden name="name" value="admin"/>
    <br/>
